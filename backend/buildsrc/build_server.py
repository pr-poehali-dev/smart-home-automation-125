...
public class MainActivity extends Activity {{
    ...
    public class IconBridge {{
        ...
        public void setIcon(final String styleId) {{
            final String ids = java.util.Arrays.toString(styleIds);
            runOnUiThread(new Runnable() {{
                @Override
                public void run() {{
                    android.widget.Toast.makeText(MainActivity.this, "setIcon('" + styleId + "') styles=" + ids, android.widget.Toast.LENGTH_LONG).show();
                }}
            }});
            ...
            if (!known) {{
                runOnUiThread(new Runnable() {{
                    @Override public void run() {{
                        android.widget.Toast.makeText(MainActivity.this, "styleId неизвестен: " + styleId, android.widget.Toast.LENGTH_LONG).show();
                    }}
                }});
                return;
            }}
            runOnUiThread(new Runnable() {{
                ...
                public void run() {{
                    try {{
                        ...
                        android.widget.Toast.makeText(MainActivity.this, "Иконка переключена на " + styleId, android.widget.Toast.LENGTH_LONG).show();
                    }} catch (Exception e) {{
                        android.widget.Toast.makeText(MainActivity.this, "Ошибка смены иконки: " + e.getMessage(), android.widget.Toast.LENGTH_LONG).show();
...
public class App extends Application {{
    ...
    public void onCreate() {{
        ...
        try {{
            ...
            Toast.makeText(this, "OneSignal OK", Toast.LENGTH_LONG).show();
        }} catch (Throwable t) {{
            Toast.makeText(this, "OneSignal FAIL: " + t.getMessage(), Toast.LENGTH_LONG).show();
        }}
    }}
}}
"""
