...
import { BuilderState, SectionId } from "../types"
...
export default function OverridesSection({ state, update, onNavigate }: Props) {
  const goToDocs = () => onNavigate?.("documentation")
